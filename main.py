...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha1', type=float, default=1.0, help='Alpha value for MLP-KAN classifier.')
    parser.add_argument('--alpha2', type=float, default=0.0, help='Alpha value for MLP-KAN classifier.')
    parser.add_argument('--activation', type=str, default='silu', choices=['relu', 'silu','identity'], help='Activation function for MLP-KAN classifier.')
