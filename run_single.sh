srun -K  --job-name=GNU --partition=batch,RTX3090,V100-32GB,RTXA6000,RTXA6000-EI --gpus=1 --cpus-per-task=2 --mem=32G --time=2-00:00 --output output/console.%A_%a.out --error output/console.%A_%a.error  \
