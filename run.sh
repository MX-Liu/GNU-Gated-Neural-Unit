srun -K  --job-name=GNU --partition=RTXA6000,RTX6000-EI --gpus=1 --cpus-per-task=12 --mem=64G --time=2-00:00 --output output/console.%A_%a.out --error output/console.%A_%a.error  \
