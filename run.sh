srun -K  --job-name=GNU --partition=A100-PCI,RTXA6000,RTXA6000-EI,B200-TRU --gpus=1 --cpus-per-task=9 --mem=64G --time=2-00:00 --output output/console.%A_%a.out --error output/console.%A_%a.error  \
